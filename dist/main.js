...
/* harmony export */ });
/* harmony import */ var date_fns_isBefore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns/isBefore */ "./node_modules/date-fns/esm/isBefore/index.js");
/* harmony import */ var date_fns_getWeek__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns/getWeek */ "./node_modules/date-fns/esm/getWeek/index.js");
...
const sortTask = function (listIndex) {
  ...
  tasks.lists[listIndex].tasks.sort((a, b) => {
    ...
    if ((0,date_fns_isBefore__WEBPACK_IMPORTED_MODULE_0__["default"])(b, a)) return -1;
  });
};
  ...
  for (let i; i < tasks.lists.length; i++) {
    for (let j; j < tasks.lists.length; j++) {
      tasks.lists[i].tasks = tasks.lists[i].tasks.filter(() => {
        ...
        if ((0,date_fns_getWeek__WEBPACK_IMPORTED_MODULE_1__["default"])(taskDate == currentDate)) {
          console.log(true);
          return true;
        }
      });
...
let tasks = (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.task)();
...
const sortTask = function (listIndex) {
  ...
  tasks.lists[listIndex].tasks.sort((a, b) => {
    ...
    if ((0,date_fns_isBefore__WEBPACK_IMPORTED_MODULE_2__["default"])(bDate, aDate)) {
      return 1;
    } else return -1;
  });
};
...
const taskDetail = function (listIndex, taskIndex) {
  ...
  const arrayDate = (0,_functions_js__WEBPACK_IMPORTED_MODULE_1__.dateArray)(tasks, listIndex, taskIndex);

  dueDate.textContent = `Due Date${(0,date_fns_format__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(...arrayDate), "PPPP")}`; ///////////////////////////////////////////
